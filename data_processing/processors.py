...
class Com2SenseDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ## Note: Should be good... Can double-check
        ## check Part 4 Experiment, see if "domain","scenario","numeracy" needs to be taken care of here
        ## My guess is no for milestone 2...
        example=self.examples[idx]
        guid = example.guid
        text = example.text
